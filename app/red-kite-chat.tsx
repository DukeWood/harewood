...
function answerFor(input: string): Message {
  ...
  if (/(history|harewood house|slavery|heritage)/.test(q)) {
    return { role: "bot", text: "Harewood village and Harewood House are distinct places with intertwined histories. The older village centred near All Saints’ Church; today’s stone village was substantially rebuilt as a model estate community, including cottages for workers and woodsmen. Harewood House is the neighbouring mansion whose estate employed generations of villagers. Its own history includes wealth made through Caribbean sugar plantations and enslaved labour.", link: { label: "About the village", href: "#about-village" } };
  }
